...
from .unet_rsa_attention import AttentionRSAUnet
from .unet3d import UNet3D
from monai.networks.nets import SegResNet, UNet, UNETR, AttentionUnet, DynUNet, BasicUnetPlusPlus, VNet, SEResNet50, RegUNet
    ...
    if args.model == "unet-monai":
        ...
        model = UNet3D(
            ...
            model = SegResNet(
                        ...
                        blocks_up=[1, 1, 1],
                        init_filters=16,
                        in_channels=args.n_in,
                        out_channels=args.n_out,
                        dropout_prob=0.2,
                    )
    else:
